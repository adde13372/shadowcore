...
enum HotfixDatabaseStatements : uint32
{
    ...
    */
    ...
    HOTFIX_SEL_ITEM_BONUS_LIST_GROUP,
    HOTFIX_SEL_ITEM_BONUS_LIST_GROUP_MAX_ID,

    HOTFIX_SEL_ITEM_BONUS_LIST_LEVEL_DELTA,
    HOTFIX_SEL_ITEM_BONUS_LIST_LEVEL_DELTA_MAX_ID,

    HOTFIX_SEL_ITEM_BONUS_SEQUENCE_SPELL,
    HOTFIX_SEL_ITEM_BONUS_SEQUENCE_SPELL_MAX_ID,
