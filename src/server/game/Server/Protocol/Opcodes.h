...
enum OpcodeClient : uint16
{
    ...
    CMSG_GUILD_BANK_MOVE_ITEMS_PLAYER_BANK            = 0x34BD,
    CMSG_GUILD_BANK_MOVE_ITEMS_BANK_PLAYER            = 0x34BE,
    CMSG_GUILD_BANK_MOVE_ITEMS_BANK_BANK              = 0x34C1,
    CMSG_GUILD_BANK_MOVE_ITEMS_PLAYER_BANK_COUNT      = 0x34C3,
    CMSG_GUILD_BANK_MOVE_ITEMS_BANK_PLAYER_COUNT      = 0x34C5,
    CMSG_GUILD_BANK_MOVE_ITEMS_BANK_BANK_COUNT        = 0x34C8,
    CMSG_GUILD_BANK_MERGE_ITEMS_PLAYER_BANK           = 0x34C2,
    CMSG_GUILD_BANK_MERGE_ITEMS_BANK_PLAYER           = 0x34C6,
