...
SpellImplicitTargetInfo::StaticData  SpellImplicitTargetInfo::_data[TOTAL_SPELL_TARGETS] =
{
    ...
    {TARGET_OBJECT_TYPE_NONE, TARGET_REFERENCE_TYPE_NONE,   TARGET_SELECT_CATEGORY_NYI,     TARGET_CHECK_DEFAULT,  TARGET_DIR_NONE},        // 151
};
...
{
    // Mardum spell 193387 "The Keystone: Quest Completion - Play Metamorphosis Scene"
    if((Id==193387) && (map_id==1481) && (zone_id==7705) && (area_id==7749))
    {
        return SPELL_CAST_OK;
    }
