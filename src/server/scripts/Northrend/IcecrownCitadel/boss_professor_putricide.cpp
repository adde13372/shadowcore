                ...
                switch (id)
                {
                    ...
                    case POINT_TABLE:
                        ...
                        switch (_phase)
                        {
                            case PHASE_COMBAT_2:
                            {
                                SpellInfo const* spell = sSpellMgr->GetSpellInfo(SPELL_CREATE_CONCOCTION, DIFFICULTY_NONE);
                            ...
                            case PHASE_COMBAT_3:
                            {
                                SpellInfo const* spell = sSpellMgr->GetSpellInfo(SPELL_GUZZLE_POTIONS, DIFFICULTY_NONE);
    ...
    public:
        ...
        class spell_putricide_mutated_plague_AuraScript : public AuraScript
        {
            ...
            void HandleTriggerSpell(AuraEffect const* aurEff)
            {
                ...
                SpellInfo const* spell = sSpellMgr->AssertSpellInfo(triggerSpell, DIFFICULTY_NONE);
            ...
            void OnRemove(AuraEffect const* /*aurEff*/, AuraEffectHandleModes /*mode*/)
            {
                ...
                SpellInfo const* healSpellInfo = sSpellMgr->GetSpellInfo(healSpell, DIFFICULTY_NONE);
    ...
    public:
        ...
        class spell_putricide_clear_aura_effect_value_SpellScript : public SpellScript
        {
            ...
            void HandleScript(SpellEffIndex effIndex)
            {
                ...
                if (!target)
                    return;
                target->RemoveAura(72451);
                target->RemoveAura(71618);
            }
