...
public:
    ...
    class spell_thorim_frostbolt_volley_SpellScript : public SpellScript
    {
        ...
        void Register() override
        {
            OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_thorim_frostbolt_volley_SpellScript::FilterTargets, uint8(EFFECT_ALL), TARGET_UNIT_SRC_AREA_ENEMY);
        }
    };
...
public:
    ...
    class spell_thorim_stormhammer_SpellScript : public SpellScript
    {
        ...
        void Register() override
        {
            OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_thorim_stormhammer_SpellScript::FilterTargets, uint8(EFFECT_ALL), TARGET_UNIT_SRC_AREA_ENEMY);
