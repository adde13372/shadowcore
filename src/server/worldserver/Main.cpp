...
char serviceLongName[] = "ShadowCore world service";
char serviceDescription[] = "ShadowCore World of Warcraft emulator world service";
/*
...
extern int main(int argc, char** argv)
{
    ...
    TC_LOG_INFO("server.worldserver", "ShadowCore official discord: https://discord.gg/57D59ed ShadowCoreTeam@yahoo.com");
